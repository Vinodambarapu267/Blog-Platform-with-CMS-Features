...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .exceptionHandling(ex -> ex
                ...
                .accessDeniedHandler((req, res, e) -> writeJsonError(res, HttpStatus.FORBIDDEN, "You do not have permission to perform this action"))
            )
    ...
    private void writeJsonError(jakarta.servlet.http.HttpServletResponse response, HttpStatus status, String message) throws IOException {
